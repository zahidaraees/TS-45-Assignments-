...
*/
var devices = ["Desktop", "Laptop", "Tablets", "Androids", "Printers"]; //created array with its items
var newInd = devices.length; // checked length of array because I will have to push new itm in array
