...
*/
let idcard: string = "1234567-2";
let studentName: string = "Muhammad Hayyan";
let age: number = 9;
let classRoom: number = 3;
let suspended: boolean = false;
let studentArray:string[] = ["Affan", "Hayyan", "Musab", "Sara", "Maham"];
//• Tests for equality and inequality with strings
console.log(
  "studentName=='Muhammad Hayyan' && idcard!=='2345678-1'. My prediction is True"
);
console.log(studentName == "Muhammad Hayyan" && idcard !== "2345678-1");

//• Tests using the lower case function
console.log(
  "studentName.toLowerCase=='muhammad hayyan' . My prediction is True"
);
...
console.log(
  "Age is less than 12, greater than and equal to 9 = ",
  age < 12 && age >= 9
);
...
//• Tests using "and" and "or" operators
console.log(
  studentName.toLowerCase() == "muhammad hayyan" &&
    studentName == "Muhammad Hayyan"
