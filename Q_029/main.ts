...
let favoriteFruits: string[] = ["bananas", "apples", "oranges"]; //Favorite Fruit: Make a array of your favorite fruits
...
//• Make a array of your three favorite fruits and call it favorite_fruits.
let favorite_fruits: string[] = ["graps", "pineapples", "watermelons"];
